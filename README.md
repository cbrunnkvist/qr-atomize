...
| Input | Output |
|:-----:|:------:|
| ![290×290 px input (6.9 KB)](test/fixtures/valid-qr.png) | ![29×29 px output (197 B)](test/fixtures/valid-qr-atomized.png) |
| 290×290 px input (6.9 KB) | 29×29 px output (197 B) — _97% reduction!_ |
